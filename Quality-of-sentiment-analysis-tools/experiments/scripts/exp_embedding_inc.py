...
def main(args):
    ...
    for dir in dirs:
        ...
        for file in onlyfiles:
            ...
            dfi[datasets[i]][embbedings[nb_dir-1]] = get_inc_mean_inc(join(dir, file))
            i = i+1
    ...
    ax.set_title("inc & Embedding type", fontsize=8)
    bars = dfi.plot (kind='bar' , ax=ax , width=0.5 , colors=["#660000" , "#ff6666", "#ffb2b2"] , linewidth=0.5 ,
                     edgecolor="black", alpha=0.8)
    plt.xticks ([0,1,2,3] , embbedings , rotation=10, fontsize=8)
