...
def main(args):
    ...
    for file in onlyfiles:
         ...
         markeredgewidth=0.5)
            ...
            plt.xticks ([0,0.1,0.2,0.5],["0","0.1","0.2","0.5"],rotation=45,fontsize=8)
            ...
            plt.yticks ([0.09,0.12,0.15,0.17,0.19],["0.09","0.12","0.15","0.17","0.19"],rotation=45,fontsize=8)
    ...
    ax.set_title("Inc & dropout p",fontsize=8)
