...
def main(args):
    ...
    for file in onlyfiles:
            ...
            plt.xticks ([50,100,150,200,300],["5e","1e2","1.5e","2e2","3e2"],rotation=45,fontsize=8)
            plt.yticks (rotation=45,fontsize=8)
            #ax = fig.add_subplot (3 , 8 , 2)
            sns.lineplot (nb_epochs,accs  , ax=ax , markersize=5,marker=markers[i], linewidth=1,
    ...
    ax.set_title("Acc & nb_epochs",fontsize=8)
